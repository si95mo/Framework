...
namespace Extensions
{
    ...
    public static class ConditionExtensions
    {
        ...
        {
            ConditionFlyweight result = new ConditionFlyweight($"{source.Code}.IsTrue", source.Value);
        ...
        {
            ConditionFlyweight result = new ConditionFlyweight($"{source.Code}.IsFalse", source.Value == false);
        ...
        private static void UpdateIsFalseCondition(ICondition source, ConditionFlyweight newCondition)
        ...
        public static ConditionFlyweight And(this ICondition source, ICondition condition)
        {
            ConditionFlyweight andCondition = new ConditionFlyweight($"{source.Code}.And.{condition.Code}", source.Value & condition.Value);
        ...
        /// <param name="andCondition">The <see cref="ConditionFlyweight"/> result of the <see cref="And(ICondition, ICondition)"/> method</param>
        private static void UpdateAndCondition(ICondition changedCondition, ConditionFlyweight andCondition)
        ...
        /// <param name="condition">The other condition to which concatenate</param>
        /// <returns>The concatenated <see cref="ConditionFlyweight"/></returns>
        public static ConditionFlyweight Or(this ICondition source, ICondition condition)
        {
            ConditionFlyweight orCondition = new ConditionFlyweight($"{source.Code}.And.{condition.Code}", source.Value | condition.Value);
        ...
        private static void UpdateOrCondition(ICondition changedCondition, ConditionFlyweight andCondition)
            => andCondition.Value |= changedCondition.Value;
    }
