...
namespace Hardware.Resources.Tests
{
    ...
    {
        private readonly string amsNetAddress = "169.254.174.61.1.1"; // Check which is correct for the local ads server. The amsnet address is not used in case of a local ads server
